...
In this project we will build such a pipeline. The link of W&B project nyc_airbnb:

```
https://wandb.ai/sunparu/nyc_airbnb/overview
```

and the GitHub Repository link:

```
https://github.com/sunparu13/build-ml-pipeline-for-short-term-rental-prices
```
